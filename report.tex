...
Let $n \in \mathbb{N}$ be the bitlength of the digest, then the secret key would be: \[k_\text{priv}= (S_{0,0},S_{0,1}) || (S_{1,0},S_{1,1})|| \dots || (S_{n,0},S_{n,1})\]
...
These secrets are then hashed (with a one-way function $h$) and published as the public key \[
