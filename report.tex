...
Since the IoT consists of very different types of constrained nodes the IETF introduced different classes on which to classify IoT nodes, these three classes however only classify devices below 50KiB of RAM which isnt feasable.
Nevertheless they also introduce some classification based on Energy constrains. %TODO
